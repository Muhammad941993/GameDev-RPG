...
namespace RPG.Saving
{
    ...
    public class SaveableEntity : MonoBehaviour
    {
        ...
        public static Dictionary<string, SaveableEntity> GlobalLookUp = new();
        public string GetUnicqeID() { return UniqueIdentifire; }
        ...
        public void RestoreState(object state)
        {
            ...
            foreach (ISaveable saveable in GetComponents<ISaveable>())
            {
                ...
                {
                    saveable.RestoreState(states[name]);
                }
               
            }
            //SerializableVector3 oldPos = (SerializableVector3)state;
            //GetComponent<NavMeshAgent>().enabled = false;
            //transform.position = oldPos.ToVector(); 
        ...
        private bool IsUnique(string candiate)
        {
            ...
            if(GlobalLookUp[candiate].GetUnicqeID() != candiate)
            {
                GlobalLookUp.Remove(candiate);
                return true;
            }
